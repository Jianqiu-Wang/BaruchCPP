...
Point::Point(): Shape()
{
	std::cout << "Calling Point Constructor(default)" << std::endl;
}

// Copy constructor
Point::Point(const Point& p): Shape(p), m_x(p.m_x), m_y(p.m_y)
{
	std::cout << "Calling Point Constructor(copy)" << std::endl;
}

// Constructor giving coordinates x and y
Point::Point(double x, double y): m_x(x), m_y(y)
{
	std::cout << "Calling Point Constructor(by coordinates)" << std::endl;
}

// Construct from same x- and y- coordinate
Point::Point(double xy): m_x(xy), m_y(xy)
{
	std::cout << "Calling Point Constructor" << std::endl;
}
// Deconstructor of class Point
Point::~Point()
{
	std::cout << "Calling Point Destructor" << std::endl;
}
...
Point& Point::operator= (const Point& source)
{
	...
	std::cout << "Calling Point assigment operator" << std::endl;
